...
type ProjectsClient interface {
	...
	Delete(ctx context.Context, in *ProjectInfo, opts ...grpc.CallOption) (*proto_common.EmptyMessage, error)
}
...
func (c *projectsClient) Delete(ctx context.Context, in *ProjectInfo, opts ...grpc.CallOption) (*proto_common.EmptyMessage, error) {
...
type ProjectsServer interface {
	...
	Delete(context.Context, *ProjectInfo) (*proto_common.EmptyMessage, error)
...
func (UnimplementedProjectsServer) Delete(context.Context, *ProjectInfo) (*proto_common.EmptyMessage, error) {
